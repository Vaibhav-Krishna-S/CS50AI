...
def shortest_path(source, target):
    ...
    # Loop until the frontier is empty (BFS exploration)
    while not frontier.empty():
        # Remove a node from the frontier (FIFO queue for BFS)
        node = frontier.remove()

        # If this node contains the target, reconstruct the path and return it
